...
/// Trigger : A build trigger that automatically starts new builds when specified criteria are met.
...
pub struct Trigger {
    ...
    #[serde(rename = "buildCustomization", skip_serializing_if = "Option::is_none")]
    pub build_customization: Option<Box<models::BuildTriggerCustomization>>,
}
