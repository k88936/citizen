...
/// ArtifactDependency : An artifact dependency that defines rules for passing artifacts from an upstream build configuration to a target downstream configuration.
