...
------------ | ------------- | ------------- | -------------
**count** | Option<**i32**> | The number of roots in this collection. | [optional]
...
**vcs_root** | Option<[**Vec<models::VcsRoot>**](VcsRoot.md)> | The list of roots owned by this collection that satisfy the given locator. | [optional]
