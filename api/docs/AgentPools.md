...
------------ | ------------- | ------------- | -------------
**count** | Option<**i32**> | The current number of AgentPool objects in this list. | [optional]
...
**agent_pool** | Option<[**Vec<models::AgentPool>**](AgentPool.md)> | The list of AgentPools owned by this collection. | [optional]
