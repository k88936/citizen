...
------------ | ------------- | ------------- | -------------
**count** | Option<**i32**> | The current number of HealthItem objects in this collection. | [optional]
**health_item** | Option<[**Vec<models::HealthItem>**](HealthItem.md)> | The list of HealthItem objects in this collection. | [optional]
