...
------------ | ------------- | ------------- | -------------
**count** | Option<**i32**> | The current number of AuditEvent objects in this list. | [optional]
...
**audit_event** | Option<[**Vec<models::AuditEvent>**](AuditEvent.md)> | The list of audit events owned by this collection that satisfy the given locator. | [optional]
