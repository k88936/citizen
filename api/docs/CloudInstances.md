...
------------ | ------------- | ------------- | -------------
**count** | Option<**i32**> | The number of CloudInstance objects in this collection. | [optional]
...
**cloud_instance** | Option<[**Vec<models::CloudInstance>**](CloudInstance.md)> | The list of CloudInstance objects owned by this collection. | [optional]
