...
------------ | ------------- | ------------- | -------------
**count** | Option<**i32**> | The number of root instances in this collection. | [optional]
...
**vcs_root_instance** | Option<[**Vec<models::VcsRootInstance>**](VcsRootInstance.md)> | The list of root instances owned by this collection that satisfy the given locator. | [optional]
